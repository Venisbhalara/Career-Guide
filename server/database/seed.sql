-- Seed data for Career Guide Platform
...
VALUES
    -- Software Developer
    (1, 1, 'advanced', 'required'),
    (1, 2, 'advanced', 'required'),
    (1, 5, 'advanced', 'required'),
    (
        1,
        8,
        'intermediate',
...
(2, 1, 'expert', 'required'),
(2, 3, 'expert', 'required'),
(2, 9, 'advanced', 'required'),
(2, 10, 'advanced', 'required'),
(2, 18, 'advanced', 'required'),
(2, 5, 'advanced', 'required'),

-- Digital Marketing
(3, 4, 'advanced', 'required'),
(3, 7, 'advanced', 'required'),
(3, 17, 'advanced', 'required'),
(
    3,
    3,
    'intermediate',
...
-- Doctor
(5, 19, 'expert', 'required'),
(5, 20, 'expert', 'required'),
(5, 4, 'advanced', 'required'),
(5, 14, 'advanced', 'required'),
(5, 13, 'advanced', 'required'),

-- Civil Engineer
(6, 18, 'advanced', 'required'),
(6, 5, 'advanced', 'required'),
(
    6,
    8,
    'advanced',
...
-- Content Writer
(7, 17, 'expert', 'required'),
(7, 4, 'advanced', 'required'),
(
    7,
    7,
    'advanced',
...
-- Chartered Accountant
(8, 18, 'expert', 'required'),
(8, 3, 'advanced', 'required'),
(8, 14, 'advanced', 'required'),
(8, 16, 'advanced', 'required'),

-- UI/UX Designer
(9, 11, 'expert', 'required'),
(9, 7, 'advanced', 'required'),
(9, 13, 'advanced', 'required'),
(
    9,
    4,
    'intermediate',
